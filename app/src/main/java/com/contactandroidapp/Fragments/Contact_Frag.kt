...
import com.contactandroidapp.Adapter.ContactAdapter
...
class Contact_Frag : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapterList = viewModel.readContacts(requireContext(),adapterList)
        contactRecyclerviewFragBinding.recyclerviewf1.adapter= ContactAdapter(requireContext(),adapterList)
    }
}